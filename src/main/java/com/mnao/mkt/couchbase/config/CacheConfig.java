package com.mnao.mkt.couchbase.config;
...
public class CacheConfig {
    ...
    public static final String CACHE_NAME = "marketing";
    
	@Value("${mkt.couchbase.server}")
    private String couchbaseServer;
	
	@Value("${mkt.couchbase.bucket}")
	private String couchbaseBucket;
	
	@Value("${mkt.couchbase.password}")
    ...
    public Bucket bucket() {
        // connect to the bucket named 'mktbucket' (which must exist on your Couchbase server)
